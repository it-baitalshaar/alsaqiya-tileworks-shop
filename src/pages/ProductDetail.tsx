...
const PostDetail = () => {
  ...
  if (isLoading) return <div className="p-8">Loading post...</div>
  ...
  return (
    <div className="container mx-auto p-8 max-w-4xl">
      ...
      <article>
        ...
        {/* Basic body content - you might want to use PortableText for rich text */}
        <div className="prose max-w-none">
          {typeof post.body === 'string' ? (
            <p>{post.body}</p>
          ) : (
            <p>Rich content goes here (install @portabletext/react for rich text)</p>
          )}
        </div>
      </article>
    </div>
